...
(function () {
  ...
  var goals = {
    ...
    allIC: {
      ...
      why: 'Each one is harder than the last. Beating all nine unlocks the next stage.',
      topic: 'challenges',
    },
    breakInf: {
  ...
  var topics = [
    ...
    },
    {
      ...
      how: [
        ...
        'A ring’s level sets its speed: laps per second = level × the ring’s base speed × speed bonuses from later features.',
    ...
    },
    {
      ...
      summary: 'Nine runs, each with its own handicap; reach {INF} score under one to beat it and earn a permanent reward.',
      how: [
  ...
  var cards = {
    ...
    icSeen: {
      ...
      why: 'Each one gives a permanent reward and more IP per Infinity. All nine unlock the next stage.',
  ...
  var glossary = [
    ...
    { term: 'Level', unlock: null, def: 'How fast a ring spins. Laps per second = level × the ring’s base speed × speed bonuses from later features.' },
    ...
    { term: 'Revolution', unlock: null, def: 'The first stage of the game: rings, levels, multipliers and the resets you unlock before Infinity.' },
