...
const Engine = (() => {
  ...
  function pendingPrestige(s) {
    ...
    const pMult = Math.pow(TUNE.pMultBase * (s.scoreLog - 3) ** TUNE.pMultPow * m.pMultMult, m.gainPow);
